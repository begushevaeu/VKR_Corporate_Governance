...
stargazer(selected_models,
          type = "html",
          out = "output/logit_regressions_interactions/day30_ready_UNDP_5_interactions_p05.html",
          title = "Логистические модели (чистые данные, день 30, UNDP_5): ПИ и взаимодействие значимы на 5%")
...
stargazer(selected_models,
          type = "html",
          out = "output/logit_regressions_interactions/day30_ready_UNDP_10_interactions_p05.html",
          title = "Логистические модели (чистые данные, день 30, UNDP_10): ПИ и взаимодействие значимы на 5%")
