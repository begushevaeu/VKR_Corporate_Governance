...
stargazer(selected_models,
          type = "html",
          out = "output/linear_regressions_interactions/day1_ready_interactions.html",
          title = "Линейные модели (чистые данные, день 1): значимые ПИ и взаимодействия")