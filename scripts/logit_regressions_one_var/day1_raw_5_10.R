...
data_BS <- readRDS("data/regressions/raw_log/day1/day1_Board_size_log_log5.rds")
data_In <- readRDS("data/regressions/raw_log/day1/day1_Independence_log5.rds")
data_MA <- readRDS("data/regressions/raw_log/day1/day1_Mean_age_log_log5.rds")
data_GV <- readRDS("data/regressions/raw_log/day1/day1_Gender_variability_log5.rds")
data_IL <- readRDS("data/regressions/raw_log/day1/day1_Independent_leader_log5.rds")
data_CE <- readRDS("data/regressions/raw_log/day1/day1_Current_exp_log_log5.rds")
data_PE <- readRDS("data/regressions/raw_log/day1/day1_Past_exp_log_log5.rds")
data_NC <- readRDS("data/regressions/raw_log/day1/day1_Number_of_committees_log5.rds")
data_FD <- readRDS("data/regressions/raw_log/day1/day1_Foreign_directors_log5.rds")
...
stargazer(BS, In, MA, GV, IL, CE, PE, NC, FD,
          type = "html",
          out = "output/logit_regressions_one_var/day1_raw_log5.html",
          title = "Логистические регрессии (5% порог) по грязным данным (day1)")

#### ПОРОГ 10% ####

#### === Загрузка данных === ####

data_BS <- readRDS("data/regressions/raw_log/day1/day1_Board_size_log_log10.rds")
data_In <- readRDS("data/regressions/raw_log/day1/day1_Independence_log10.rds")
data_MA <- readRDS("data/regressions/raw_log/day1/day1_Mean_age_log_log10.rds")
data_GV <- readRDS("data/regressions/raw_log/day1/day1_Gender_variability_log10.rds")
data_IL <- readRDS("data/regressions/raw_log/day1/day1_Independent_leader_log10.rds")
data_CE <- readRDS("data/regressions/raw_log/day1/day1_Current_exp_log_log10.rds")
data_PE <- readRDS("data/regressions/raw_log/day1/day1_Past_exp_log_log10.rds")
data_NC <- readRDS("data/regressions/raw_log/day1/day1_Number_of_committees_log10.rds")
data_FD <- readRDS("data/regressions/raw_log/day1/day1_Foreign_directors_log10.rds")
...
stargazer(BS, In, MA, GV, IL, CE, PE, NC, FD,
          type = "html",
          out = "output/logit_regressions_one_var/day1_raw_log10.html",
          title = "Логистические регрессии (10% порог) по грязным данным (day1)")
